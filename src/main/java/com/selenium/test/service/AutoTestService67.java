...
public class AutoTestService67 implements TestService {
	
	private static Logger logger = LoggerFactory.getLogger(AutoTestService67.class);
...
//		    public Boolean apply(WebDriver d) {
//		        try {
//		        return d.findElement(By.id("objectNavigatorToolbarAdministrationBtn")).isDisplayed();
//		        }catch(Exception e){
//		            return false;
//		        }
//		    }
...
//		driver.quit();
	...
	public void installPlugin(WebDriver driver){
        ...
        WebElement configIcon = driver.findElement(By.id("objectNavigatorToolbarAdministrationBtn"));
        configIcon.click();
